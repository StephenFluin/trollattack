...
public class Exit {
    ...
    public Exit(int dest, int direct, boolean isDoor, boolean isLocked, Item doorKey) {
        destination = dest;
        direction = direct;
        this.isDoor = isDoor;
        locked = isLocked;
    ...
    directionList[SOUTH] = "south";
    directionList[UP] = "up";
    directionList[DOWN] = "down";
    directionList[NORTHEAST] = "northeast";
    directionList[NORTHWEST] = "northwest";
    directionList[SOUTHEAST] = "southeast";
    directionList[SOUTHWEST] = "southwest";
    I WISH! */
    ...
    public Exit getOtherExit() {
        return getDestinationRoom().followLink(Exit.directionOpposite(direction));
    }
    ...
    public String open() { return open(true); }
    public String close() { return close(true); }
